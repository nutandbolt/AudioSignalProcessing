...
"""
def estimateInharmonicity(inputFile = '../../sounds/piano.wav', t1=2.3, t2=2.55, window='hamming', 
                            M=2047, N=2048, H=128, f0et=5.0, t=-90, minf0=230, maxf0=290, nH = 15):
    """
    ...
    xhfreq, xhmag, xhphas=HM.harmonicModelAnal(x, fs, w, N, H, t, nH, minf0, maxf0, f0et, harmDevSlope=0.01, minSineDur=0.0)  
    ...
    for val in range(start,end+1):
        ...
        for index,freq in enumerate(frame):
            ...
            if index ==0:    
                ...
                if (freq != 0.0) :
                    count+=1
                    sum=(sum+abs(freq-(index+1)*f0_freq)/float(index+1))
