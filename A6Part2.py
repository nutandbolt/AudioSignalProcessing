...
def segmentStableNotesRegions(inputFile = '../../sounds/cello-phrase.wav', stdThsld=20, minNoteDur=0.5, 
    ...
    for i in range(2,len(f0_cent)):
        SD_winstable.append(np.std([f0_cent[i],f0_cent[i-1],f0_cent[i-2]]))
